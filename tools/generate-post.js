...
function makeHtmlFile(text) {
  ...
  downloadBtn.download = "Your post";
...
function convertMarkdown(shouldDownload) {
  ...
  if (shouldDownload) {
    var fullHtml = HTML_START + clean + HTML_END;
    makeHtmlFile(fullHtml);
  }
}
